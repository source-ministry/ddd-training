...
use LibraryBundle\Entity\Reader;
use LibraryBundle\Form\ReaderType;
...
class ReaderController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LibraryBundle:Reader')->findAll();
     ...
     * @Method("POST")
     * @Template("LibraryBundle:Reader:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('reader_show', array('id' => $entity->getId())));
        }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LibraryBundle:Reader')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("LibraryBundle:Reader:edit.html.twig")
     */
